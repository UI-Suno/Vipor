...
if not makefolder then
    ...
    if isfolder("Vipor\\Downloads") then
        if isfile("Vipor\\Downloads\\Developer.lua") then
            if
                readfile("Vipor\\Downloads\\Developer.lua") == true or
                    readfile("Vipor\\Downloads\\Developer.lua") == "true"
             then
                delfolder("Vipor")
            end
        end
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/UI-Suno/Vipor/main/Configurations/Executor.lua", true))(
    "Executor"
)
loadstring(game:HttpGet("https://raw.githubusercontent.com/UI-Suno/Vipor/main/Project/Downloads.lua", true))(
    "Downloads"
)
