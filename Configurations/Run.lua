...
writefile("Vipor\\Scripts\\1962086868.lua", "loadstring(game:HttpGet('https://raw.githubusercontent.com/UI-Suno/Vipor/main/Scripts/1962086868.lua', true))('9346039031')")

if game.PlaceId == 1962086868 then
    dofile("Vipor\\Scripts\\1962086868.lua")
end